              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    type="password"
                    autoComplete="confarm-password"
                    required
                    className="block p-4 pb-2 w-full  rounded-full border-0 py-1.5 text-black dark:text-white dark:bg-transparent shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-"
                  />
                </div>
              </div>
